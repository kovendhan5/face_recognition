...
# Function to get the total registered users
def totalreg():
...
# Add attendance if within the specified time (8 AM to 4 PM)
    ...
    if start_time <= current_time <= end_time:
        ...
        if int(userid) not in list(df['Roll']):
            with open(f'Attendance/Attendance-{datetoday}.csv', 'a') as f:
                f.write(f'\n{username},{userid},{attendance_time}')
    else:
        print("Attendance not allowed outside of 8 AM - 4 PM")
